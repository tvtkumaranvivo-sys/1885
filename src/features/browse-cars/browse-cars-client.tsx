...
return (
    <main>
      ...
      <section className="border-b bg-ivory px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 flex max-w-3xl items-center gap-2 rounded-lg border bg-surface p-2 shadow-card focus-within:border-brand focus-within:ring-2 focus-within:ring-brand/15">
      ...
      <section className="bg-surface-muted px-4 py-6 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="hidden rounded-lg border bg-surface p-4 lg:block">
            <FilterFields filters={filters} onChange={updateFilter} className="grid-cols-3 xl:grid-cols-9" />
          </div>
          <Modal>
      ...
      <section className="bg-ivory px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        <div className="mx-auto max-w-7xl">
